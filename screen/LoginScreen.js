...
const E_LOGIN = ({ navigation }) => {
  ...
  return (
    <View style={{ width: "100%", height: "100%", alignItems: "center" }}>
      ...
      <View
        style={{ height: "40%", width: "100%", backgroundColor: "#F5F5F5F5" }}
      >
  ...
  return (
    <View style={{ height: "100%", width: "100%", justifyContent: "center" }}>
      ...
      <View style={style.input}>
        <Image
          source={require("../signin/images/mail.png")}
          resizeMode="stretch"
          style={style.image}
        />
        <TextInput
      ...
      <View style={style.input}>
        <Image
          source={require("../signin/images/password.png")}
          resizeMode="stretch"
          style={style.image}
        />
        <TextInput
        ...
        >
          <Image
            source={require("../signin/images/eye.png")}
            resizeMode="stretch"
            style={style.imageEye}
          ></Image>
        </TouchableOpacity>
      </View>
    ...
    <View style={{ height: "100%", width: "100%", justifyContent: "center" }}>
      ...
      <View style={style.input}>
        ...
        <TextInput
          style={style.textInput}
          autoCapitalize="none"
          secureTextEntry={pwHiddenStarted}
          placeholder="Password"
          textContentType="password"
        />
        <TouchableOpacity
...
const FOOTER = () => {
  return (
    <View style={{ width: "100%", height: "100%", alignItems: "center" }}>
      ...
      >
        <View
          style={{ height: 1, width: "25%", backgroundColor: "#4D8D6E" }}
        ></View>
        <Text style={{ color: "#4D8D6E", fontSize: 15 }}>
          {" "}
          or connect with{" "}
        </Text>
        <View
      ...
      >
        <Image
          source={require("../signin/images/googlebtn.png")}
          style={style.buttonSignWith}
        ></Image>
        <Image
          source={require("../signin/images/googlebtn.png")}
          style={style.buttonSignWith}
